...
- The overall repository hosting the toy models can be found [here](https://github.com/DynamicalSystemsGroup/bdp-toy-examples)
...
- The notebook can be found [here](https://github.com/DynamicalSystemsGroup/bdp-toy-examples/blob/main/Composite%20Processor%20Mini/Composite%20Process%20Mini.ipynb)
...
- The notebook can be found [here](https://github.com/DynamicalSystemsGroup/bdp-toy-examples/blob/main/Dynamical%20Systems/Dynamical%20Systems.ipynb)
...
- The repository can be found [here](https://github.com/DynamicalSystemsGroup/homicidal-chauffeur-canonical-example)