...
```txt
https://github.com/BlockScience/bdp-lib/tree/main/src/bdp_lib/schemas/model.schema.json
```
...
| :------------------ | :--------- | :------------- | :----------- | :---------------- | :-------------------- | :------------------ | :-------------------------------------------------------------------------------------- |
| Can be instantiated | No         | Unknown status | No           | Forbidden         | Forbidden             | none                | [model.schema.json](../../out/bdp_lib/schemas/model.schema.json "open original schema") |
